...
<form  name="register" action="member_form_edit_db.php" method="POST" class="form-horizontal">
      ...
      <input type="hidden" name="member_id" value="<?php echo $member_id; ?>">
        ...
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_pass" type="password" required class="form-control" id="m_pass" value="<?=$m_pass;?>" placeholder="Password" pattern="^[a-zA-Z0-9ก-๙]+$" minlength="2" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_name" type="text" required class="form-control" id="m_name" value="<?=$m_name;?>" placeholder="ชื่อ-สกุล " pattern="^[a-zA-Z0-9ก-๙]+$" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
        ...
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <textarea name="m_address" class="form-control" pattern="^[a-zA-Z0-9ก-๙]+$" id="m_address" required> <?php echo $m_address; ?></textarea> 
          </div>
        </div>
      <div class="form-group">
